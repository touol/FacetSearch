...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'FacetSearch',
                'description' => 'Default source for files of FacetSearch',
                ...
                'properties' => array(
                    'basePath' => array(
                        ...
                        'type' => 'textfield',
                        'lexicon' => 'core:source',
                        'value' => 'assets/images/facetsearch/',
                    ),
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'facetsearch_source_default'))) {
