...
class FacetSearchPackage
{
    ...
    /**
     * FacetSearchPackage constructor.
     *
     * @param $core_path
     * @param array $config
     */
    ...
    protected function settings()
    {
        ...
        foreach ($settings as $name => $data) {
            ...
            $attributes[xPDOTransport::UPDATE_OBJECT] = !empty($this->config['update']['settings']);
...
$install = new FacetSearchPackage(MODX_CORE_PATH, $config);
